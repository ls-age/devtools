...
function unusedPlugin(_a) {
    var _b = _a.extensions, extensions = _b === void 0 ? ['.js'] : _b, _include = _a.include, _c = _a.exitCode, exitCode = _c === void 0 ? 1 : _c, exclude = _a.exclude;
    var cwd = process.cwd();
    var include = _include || extensions.map(function (ext) { return "src/**/*" + ext; });
        ...
        buildEnd: function () {
            if (files.size > 0) {
                ...
                if (!watching) {
                    ...
                    console.log(__spreadArrays(['Unused files:'], Array.from(files).map(function (f) { return path.relative(cwd, f); })).join(os.EOL + "- "));
                }
            }
        },
    };
